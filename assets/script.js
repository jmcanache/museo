jQuery(document).ready(function($) {
   ...
   /* $('.parallax-window').parallax({
    ...
    var displayRegion = function(ciudad){
        ...
        if(Museos.length > 0){
            ...
            for (var i = 0; i < Museos.length; i++) {
                ...
                museoName = Museos[i].museo.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                    return letter.toUpperCase();
                });

                contenidoExtra = Museos[i].extraInfo ? '<div id="'+Museos[i].nombreId+'" class="btn btn-warning col-sm-4 col-xs-10 col-xs-offset-1 col-sm-offset-3 masInfo" data-toggle="modal" data-target="#masInfoModal">Más información <i class="fa fa-info-circle fa-lg"></i></div>' : "";

                link_html = '<a ' + link + ' target="_blank"><img class=" link img-responsive'+ hidden + '"src='+"images/link.png"+'></a>';
                html_cuerpo = 
                    '<div class="about container-fluid">'+
                        '<header class="row">' +
                            '<h2 class="col-md-7 col-sm-6 col-md-offset-1 col-xs-12 wowload  fadeInLeft '+animatedClass1[i]+'"><b>'+museoName+'</b></h2>'+
                            '<figure class="col-md-4 col-sm-6 col-xs-12 wowload fadeInRight '+animatedClass2[i]+'" style="padding-top: 1%">'+
                                link_html +
                            '</figure>'+
                        ' </header>'+
                        '<div class="row">'+
    ...
    $('body').on("click",".masInfo", function(){
        $('#masInfoModal .modal-body').empty();     
        $('#masInfoModal .modal-body').append(window[$(this).attr('id')].extraInfo);
    });
    ...
    setInterval(function(){
        ...
        $('.museo-activo').fadeOut(500).removeClass('museo-activo');
...
ancash2 = {img_src: "images/ancash2.png",
            link: "http://museos.cultura.pe/museos/museo-nacional-chav%C3%ADn",
...
link: "http://www.deperu.com/cultural/museos/museo-arqueologico-y-antropologico-del-ministerio-de-cultura-1269",
...
fondo: "fondo_ica",
imagenes: ["images/apurimac1.png", "images/apurimac2.png", "images/apurimac3.png"]}
...
arequipa1 = {img_src: "images/arequipa1.png",
            ...
            link: 'http://santacatalina.org.pe',
...
link: "http://deperu.com/cultural/museos/museo-de-la-memoria-4205",
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-de-quinua",
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-wari",
...
link: "http://mincetur.gob.pe/TURISMO/OTROS/inventario%20turistico/Ficha.asp?cod_Ficha=2444",
...
link: "http://deperu.com/cultural/museos/museo-de-arte-religioso-convento-de-san-francisco-2967",
...
link: "http://arqueotur.org/yacimientos/complejo-ceremonial-kuntur-wasi-y-museo-de-sitio.html",
...
link: "http://www.deperu.com/cultural/museos/museo-del-ejercito-fortaleza-del-real-felipe-1299",
...
link: "http://deperu.com/cultural/museos/museo-de-la-fuerza-de-aviacion-naval-4367",
...
link: "http://mincetur.gob.pe/TURISMO/OTROS/inventario%20turistico/Ficha.asp?cod_Ficha=2570",
...
link: "http://www.deperu.com/cultural/museos/museo-de-arte-contemporaneo-cusco-2202",
...
extraInfo:  'El Museo Larco de Lima y el BBVA Banco Continental remodelan la Casa Cabrera para '+
            'albergar el primer y único museo peruano dedicado a resaltar el arte de las antiguas culturas '+ 
            'del Perú, el Museo de Arte Precolombino.</br></br>'+ 

            'La Casa Cabrera se encuentra en uno de los lugares más apacibles y acogedores de la ciudad '+ 
            'del Cusco, la Plazoleta de las Nazarenas, a una cuadra de la Plaza de Armas.</br></br>'+ 
            
            'En este extraordinario monumento histórico se sintetiza la historia de la arquitectura urbana en '+ 
            'la ciudad imperial, desde los segmentos de muro incaico que aún se conservan, hasta los '+ 
            'balcones republicanos que dan al patio interior.</br></br>'+ 
            
            'Sirvió como sede del convento de Santa Clara hasta que en el siglo XVII, la casona fue '+ 
            'comprada por Don Jerónimo Luis de Cabrera y la Cerda, cuyo escudo nobiliario aparece hasta '+ 
            'hoy en la portada de piedra. En 1981 el Banco Continental adquirió el inmueble y realizó una '+ 
            'labor de restauración a fin de ponerla en valor, rescatando sus características arquitectónicas.</br></br>'+ 
            
            'En el 2002, el Banco Continental une esfuerzos con el Museo Larco de Lima para abrir las '+ 
            'puertas del Museo de Arte Precolombino – MAP, en junio del 2003.',
};

cuzco4 = {img_src: "images/cuzco4.png",
museo: "MUSEO MACHUPICCHU",
link: "http://www.museomachupicchu.com/#!inicio/c3c3",
...
imagenes: ["images/lozano1.png","images/lozano2.png","images/lozano3.png"]};

huancavelica2 = {img_src: "images/huancavelica2.png",
link: "http://museos.cultura.pe/museos/museo-regional-daniel-hern%C3%A1ndez-morillo",
...
horario: "martes a domingo de 9:00 a.m. a 5:00 p.m.",
email: " huancavelica@mcultura.gob.pe",
imagenes: ["images/morillo1.png","images/morillo2.png","images/morillo3.png"]};
...
link: "http://deperu.com/cultural/museos/museo-de-churubamba-4413",
...
link: "http://ilam.org/index.php/es/museo?id=220",
...
imagenes: ["images/unas1.png","images/unas2.png","images/unas3.png"]};

huanuco3 = {img_src: "images/huanuco3.png",
link: "http://museos.cultura.pe/museos/sala-de-exhibici%C3%B3n-de-la-zona-arqueol%C3%B3gica-monumental-de-kotosh",
...
link: "http://deperu.com/cultural/museos/casa-museo-maria-reiche-4299",
...
link: "http://arqueotur.org/yacimientos/museo-julio-c-tello-y-paracas-necropolis.html",
...
link: "http://museos.cultura.pe/museos/museo-regional-de-ica-adolfo-berm%C3%BAdez-jenkins",
...
link: "http://peruyello.com/company/60716/MUSEO_DE_ARQUEOLOGIA_CATALINA_HUANCA",
...
fondo: "fondo_junin",
imagenes: ["images/junin1.png","images/huanca1.png","images/huanca2.png"]};

junin2 = {img_src: "images/junin2.png",
link: "http://deperu.com/cultural/museos/museo-de-la-cultura-de-tarma-4310",
...
imagenes: ["images/junin2.png","images/tarma.png","images/tarma2.png"]};

junin3 = {img_src: "images/junin3.png",
link: "http://deperu.com/cultural/museos/museo-de-sitio-de-chacamarca-4308",
...
link: "http://deperu.com/cultural/museos/museo-etnografico-y-pinacoteca-santa-rosa-de-ocopa-4307",
...
link: "http://museoraimondi.org.pe/",
...
imagenes: ["images/libertad1.png","images/raimondi2.png","images/raimondi3.png"]};

libertad2 = {img_src: "images/libertad2.png",
nombreId: "libertad2",
museo: "MUSEO CAO ",
link: "http://fundacionwiese.com/arqueologia/museodesitiocao",
...
extraInfo:  'El museo exhibe los restos de la Señora de Cao, la primera gobernante mujer de la cultura '+ 
            'Mochica hasta ahora descubierta en el norte del país y enterrada hace unos 1.700 años.</br></br>'+ 
             
            'El museo Cao abrió sus puertas cerca del complejo arqueológico El Brujo, ubicado a una hora '+ 
            'de la ciudad de Trujillo, en el distrito de Magdalena de Cao, provincia de Ascope.</br></br>'+ 
             
            'Además de la momia tatuada del complejo El Brujo, el museo exhibe telares y cerámicas '+ 
            'pertenecientes a la cultura Mochica, algunos de los cuales datan de hace cinco mil años.</br></br>'+ 
             
            'La “Dama de los Tatuajes”, como también se le conoce, posee un estado de momificación '+ 
            'apreciable y su hallazgo despertó admiración en el mundo.',
};

libertad3 = {img_src: "images/libertad3.png",
link: "http://museos.cultura.pe/museos/museo-de-sitio-de-chan-chan",
...
link: "http://www.deperu.com/cultural/museos/museo-nacional-afroperuano-2292",
...
link: "http://museos.cultura.pe/museos/museo-arqueol%C3%B3gico-nacional-br%C3%BCning",
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-huaca-rajada-sip%C3%A1n",
...
link: "http://museos.cultura.pe/museos/museo-nacional-sic%C3%A1n",
...
nombreId: "lambayeque5",
museo: "MUSEO TUMBAS REALES DE SIPÁN ",
link: "http://museotumbasrealessipan.pe",
...
extraInfo:  'El Museo Tumbas Reales del Señor de Sipán, inaugurado en el año 2002, está ubicado en la '+
            ...
            'El principal atractivo es la tumba del Señor del Sipán, que fue descubierta en 1987 por el '+
            'arqueólogo peruano Walter Alva. Entre sus piezas se encuentran joyas, cerámicas y ajuares '+ 
            'funerarios.</br></br>'+ 
             
            'El hallazgo de las Tumbas Reales del Señor de Sipán marcó un importante hito en la '+ 
            'arqueología del continente, porque por primera vez se reveló la magnificencia y majestuosidad '+ 
            'del único gobernante del antiguo Perú encontrado hasta la fecha.',
};
...
extraInfo:'Nuestra institución parte de la iniciativa del exitoso empresario japonés, Yoshitaro Amano, por '+
            'proteger la herencia cultural del Perú de la destrucción y del saqueo.</br></br>'+ 
            
            'En sus numerosos viajes por el país, el señor Amano pudo ver los objetos abandonados por los '+ 
            'saqueadores de tumbas y, al ser una persona de gran cultura, entendió su importancia. Por '+ 
            'ello, dedicó gran parte de su tiempo y fondos a recuperar y conservar los objetos abandonados '+ 
            'en los desiertos de la costa, exponiéndolos en su casa de Miraflores.</br></br>'+ 
            
            'El Museo AMANO, ofrece un moderno planteamiento expositivo, enfocado por completo al '+ 
            'mundo de la textilería precolombina, bajo modernas condiciones de exposición y conservación. '+ 
            'Nuestra institución complementa la oferta cultural precolombina nacional, siendo el único en su '+ 
            'clase.',
};

lima2 = {img_src: "images/lima2.png",
nombreId: "lima2",
link: "http://mnaahp.cultura.pe/",
...
extraInfo:  'El Museo Nacional de Arqueología, Antropología e Historia del Perú (MNAAHP) es el primer '+
            'museo del Perú; el más grande, antiguo y representativo de nuestro país. Fue el único que tuvo '+ 
            'el Perú en los primeros cien años de la República.</br></br>'+
            ...
            'nuestro pasado prehispánico, colonial y republicano.</br></br>'+
             
            'El edificio del Museo tiene una arquitectura que combina elementos de los periodos Colonial '+
            'tardio y Republicano. Junto a sus exposiciones, hace de este un espacio de encuentro con la '+
            'historia del Perú y el lugar ideal donde todos, sin importar edad o lugar de procedencia, pueden '+ 
            'descubrir, revivir y cuestionar las vivencias de nuestros antepasados.',
};

lima3 = {img_src: "images/lima3.png",
museo: "MUSEO DE ARTE ITALIANO DE LIMA",
link: "http://museos.cultura.pe/museos/museo-de-arte-italiano-de-lima",
...
link: "http://museos.cultura.pe/museos/museo-nacional-de-la-cultura-peruana",
...
extraInfo:  'El Museo de Sitio del Santuario de Pachacamac es uno de los 52 museos del Ministerio de '+
            'Cultura; fue fundado en 1965 por Arturo Jiménez Borja con el objetivo de preservar y exponer '+ 
            'el material arqueológico recuperado durante las excavaciones realizadas por investigadores '+ 
            'nacionales y extranjeros.</br></br>'+ 
             
            'Actualmente, el Museo continúa cumpliendo este primer objetivo y trabaja para acercar a la '+
            'comunidad a su patrimonio cultural, mediante la investigación, conservación , exhibición del '+ 
            'monumento y de los materiales culturales recuperados de manera atractiva y educativa para el '+ 
            'visitante. El Museo cuenta con arqueólogos, conservadores y personal de apoyo en la parte '+ 
            'administrativa y de mantenimiento.',
};

lima6 = {img_src: "images/lima6.png",
nombreId: "lima6",
link: "http://deperu.com/cultural/museos/museo-de-la-nacion-4366",
...
extraInfo:  'El Museo, como gran conservador del patrimonio peruano, posee miles de piezas originales '+
            'correspondientes a las diferentes épocas de la historia del Perú. Las cuales ha obtenido a '+ 
            'través de investigaciones arqueológicas y de la recuperación de bienes que habían sido '+ 
            'traficados ilegalmente.</br></br>'+
             
            'Esta gran colección está conformada por más de 12 500 piezas pre hispánicas, entre las que '+ 
            'destacan colecciones de cerámicas, metales y textiles de las culturas Paracas, Moche, Wari, '+ 
            'Lima, entre otras; y más de 2500 piezas históricas de arte de la época colonial y republicana, '+ 
            'entre las que destacan colecciones de arte colonial, popular y contemporáneo. Lo que suma un '+ 
            'total de más de 15 500 piezas.</br></br>'+
             
            'El Museo de la Nación cumple también con ser el gran centro cultural del país, por ello, en sus '+
            'salas se realizan diversas actividades, como ciclos de conferencias y talleres educativos; y en '+ 
            'sus auditorios se presentan los elencos nacionales de Ballet, Folklore, la Orquesta Sinfónica '+ 
            'Nacional, el Coro Nacional, entre otros.</br></br>'+
             
            'Además, ha servido para albergar a eventos de la más alta calidad e importancia como la V '+ 
            'Cumbre de Jefes de Estado y de Gobierno de la Unión Europea, América Latina y el Caribe (AL - CUE)',
};
...
loreto1 = {img_src: "images/amazonico.png",
museo: "Museo Amazónico",
link: "http://museos.cultura.pe/museos/museo-amaz%C3%B3nico",
...
fondo: "fondo_ancash",
imagenes: ["images/amazonico.png","images/amazonico2.png","images/amazonico3.png"]}
...
link: "http://museocontisuyo.com/default_on.asp",
...
imagenes: ["images/contisuyo1.png","images/moquegua2.png","images/moquegua3.png"]}
...
link: "http://deperu.com/cultural/museos/museo-schafferer-1292",
...
fondo: "fondo_arequipa",
imagenes: ["images/pasco1.png","images/pasco2.png","images/schafferer.png"]}

pasco2 = {img_src: "images/pasco3-4.png",
museo: "Museo Municipal Simón Bolívar",
link: "http://deperu.com/cultural/museos/museo-municipal-simon-bolivar-4337",
...
imagenes: ["images/pasco3.png","images/pasco4.png","images/simon_bolivar.png"]}
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-de-narihual%C3%A1",
...
fondo: "fondo_cajamarca",
imagenes: ["images/piura1.png","images/piura2.png","images/narihuala.png"]}
...
horario: "Lunes a viernes: 09:00 am. a 5:00 pm.",
email: "simonbolivar@mcultura.gob.pe",
imagenes: ["images/simon_bolivar3.png","images/piura4.png","images/simon_bolivar2.png"]}
...
link: "http://museos.cultura.pe/museos/museo-l%C3%ADtico-de-pukara",
...
fondo: "fondo_callao",
imagenes: ["images/puno1.png","images/puno2.png","images/pukara.png"]}


puno2 = {img_src: "images/puno3-4.png",
museo: "Templo Museo San Juan de Letrán",
link: "http://museos.cultura.pe/museos/templo-museo-san-juan-de-letr%C3%A1n",
...
horario: "Martes a Domingo: 9:00 am. a 5:00 pm.",
email: "puno@mcultura.gob.pe",
imagenes: ["images/puno3.png","images/puno4.png","images/letran.png"]}
...
link: "http://museos.cultura.pe/museos/museo-departamental-san-mart%C3%ADn",
...
fondo: "fondo_cuzco",
imagenes: ["images/san_martin1.png","images/san_martin2.png","images/san_martin3.png"]}
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-las-pea%C3%B1as",
...
fondo: "fondo_huancavelica",
imagenes: ["images/tacna1.png","images/tacna2.png","images/tacna3.png"]}

tacna2 = {img_src: "images/tacna3-4.png",
museo: "Museo Histórico Regional de Tacna",
link: "http://museos.cultura.pe/museos/museo-hist%C3%B3rico-regional-de-tacna",
...
horario: "Martes a domingo: 9:00 am. a 5:00 pm.",
email: "E-mail: tacna@mcultura.gob.pe",
imagenes: ["images/tacna3.png","images/tacna4.png","images/tacna.png"]}
...
link: "http://museos.cultura.pe/museos/museo-de-sitio-cabeza-de-vaca-gran-chilimasa",
...
fondo: "fondo_huanuco",
imagenes: ["images/tumbes1.png","images/tumbes2.png","images/tumbes3.png"]}
...
link: "http://deperu.com/cultural/museos/museo-regional-de-ucayali-1298",
...
fondo: "fondo_ica",
imagenes: ["images/ucayali1.png","images/ucayali2.png","images/ucayali.png"]}
 ucayali = [ucayali1];